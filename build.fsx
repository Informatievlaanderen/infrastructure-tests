...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.Testing.Infrastructure")

Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.Testing.Infrastructure")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.Testing.Infrastructure")
