...
Target.create "Lib_Build" (fun _ ->
    buildSource "Be.Vlaanderen.Basisregisters.Testing.Infrastructure.Events"
)

Target.create "Lib_Publish" (fun _ -> publishSource "Be.Vlaanderen.Basisregisters.Testing.Infrastructure.Events")
