...
Target.create "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.Testing.Infrastructure")

Target.create "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.Testing.Infrastructure")
Target.create "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.Testing.Infrastructure")
